...
@Slf4j
@Service
public class MatriculaServiceV2Impl implements MatriculaServiceV2 {

    private final MatriculaRepository matriculaRepository;

    public MatriculaServiceV2Impl(final MatriculaRepository matriculaRepository, final MatriculaMapper matriculaMapper) {
    ...
    @Override
    public Mono<MatriculaDocument> findByCodigoMatricula(
